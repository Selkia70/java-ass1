...
public class Matrimony {
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.id("NAME")).sendKeys("Selkia");
		driver.findElement(By.id("MOTHERTONGUE")).sendKeys("Tamil");
		driver.findElement(By.id("EMAIL")).sendKeys("johnselsi043@gmail.com");
		driver.findElement(By.name("PASSWD1")).sendKeys("selkia70!");
		...
		drop7.selectByVisibleText("2000");
		
		
		driver.findElement(By.id("MOBILENO")).sendKeys("6382810309");
